        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                <form method="post" action="${pageContext.request.contextPath}/fc/bmiresult">
                    ...
                    <label class="form-check-label" for="hobby1"> Jeg går op i sund kost</label><br>
                    <input class="form-check-input" type="checkbox" id="hobby2" name="hobby" value="2">
                    <label class="form-check-label" for="hobby2"> Jeg har et sommerhus</label><br>
                    <input class="form-check-input" type="checkbox" id="hobby3" name="hobby" value="3">
                    <label class="form-check-label" for="hobby3"> Jeg har et kæledyr</label><br>
                    </div>
